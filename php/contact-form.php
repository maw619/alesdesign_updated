...
try {
	...
	$mail->Host = 'mail.alejandrasdesign.com';				       // Specify main and backup server
	$mail->SMTPAuth = true;                                  // Enable SMTP authentication
	$mail->Username = '_mainaccount@alejandrasdesign.com';                    // SMTP username
	$mail->Password = '21Isabella##';                              // SMTP password
